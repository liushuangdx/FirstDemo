<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tea_course_name.aspx.cs" Inherits="tea_course_name" %>
...
<body>
    ...
    <div>
       ...
       <div style=" margin-bottom:10px;">
            请选择课程：<asp:DropDownList ID="courseselectcontent"  runat="server"></asp:DropDownList>
            <asp:Button ID="courseselect" runat="server" Text="查询" CssClass="button"  onclick="courseselect_Click"/>
        </div>
         <asp:Panel ID="printname_panel" runat="server" Visible="true">
