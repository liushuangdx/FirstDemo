<%@ Page Language="C#" AutoEventWireup="true" CodeFile="stulist.aspx.cs" Inherits="stulist" %>
    ...
    <div>
      <asp:Panel ID="student_panel" runat="server" Visible="true">
       <div style="width:80%; margin:0 auto" id="main-content">
        <asp:Panel ID="managestudent_panel" runat="server" Visible="true">
                    ...
                    <div class="tab-content default-tab" id="Div3">
		                <div style="width:100%;">
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                ...
                                SelectCommand="SELECT * FROM [vi_student] ORDER BY [xh]"></asp:SqlDataSource>
                            <asp:ListView ID="StudentListView" runat="server" 
                              ...
                              <ItemTemplate> 
                                <tr> 
                                  ...
                                  <td><%#Eval("nl")%></td>
                                  <td><%#Eval("dept")%></td>
                                  <td><asp:Button ID="studentedit" runat="server" Text="编辑" CssClass="button" CommandArgument='<%# Eval("xh") %>' OnClick="studentedit_Click" /></td>
                                  <td><asp:Button ID="studentdelete" runat="server" Text="删除" CssClass="button" CommandArgument='<%# Eval("xh") %>' OnClick="studentdelete_Click" /></td> 
                                  <td></td> 
                                </tr> 
                              </ItemTemplate>            
                            </asp:ListView> 
             ...
             <asp:Panel ID="editstudent_panel" runat="server" Visible="false">
                    ...
                    <div class="tab-content default-tab" id="Div5">
		                ...
		                <table width="600" border="0">
                          ...
                          <tr>
			                ...
			                <td width="26%">
                                <asp:DropDownList ID="studenteditdept" runat="server">
                                </asp:DropDownList>
                            </td>
			                <td width="22%">&nbsp;</td>
		                  </tr>
