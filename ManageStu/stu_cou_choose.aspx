<%@ Page Language="C#" AutoEventWireup="true" CodeFile="stu_cou_choose.aspx.cs" Inherits="stu_cou_choose" %>
...
<body>
    ...
    <div>
      <div style="width:80%; margin:0 auto" id="main-content">
       ...
       <asp:Panel ID="choosecourse_panel" runat="server" Visible="true">
                    ...
                    <div class="tab-content default-tab" id="Div21">
		                <div style="width:100%;">
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                ...
                                SelectCommand="SELECT * FROM vi_course WHERE (kcdh NOT IN (SELECT kcdh FROM tb_study  WHERE ([xh] = @xh)))">
                                <SelectParameters>
                            ...
                            <asp:ListView ID="CourseListView" runat="server" 
                              ...
                              <ItemTemplate> 
                                <tr> 
                                  ...
                                  <td><%#Eval("xf")%></td> 
                                  <td><%#Eval("xm")%></td> 
                                  <td><asp:Button ID="choosecoursesub" runat="server" Text="选择" CssClass="button" CommandArgument='<%# Eval("kcdh") %>' OnClick="choosecoursesub_Click" /></td>
                                  <td></td> 
                                  <td></td>      
                                </tr> 
                              </ItemTemplate>            
