        ...
        <table id="indextablebody" cellpadding="0">
            <thead>
                <tr>
                    ...
                    <th>
                        <a style="color: #16547E">用户 ：<%=Session["teacher"]%></a>&nbsp;&nbsp; <a style="color: #16547E">身份 ：教师</a>&nbsp;&nbsp;
                    </th>
                </tr>
            </thead>
            <tbody>
                                    ...
                                    <td>
                                        <div id="menu" class="menu">
                                            ...
                                            <div id="left_menu_cnt1" class="left_menu_cnt">
                                                <ul id="dleft_tab1">
                                                    <li id="Li1"><a title="信息修改" onclick="show_title('信息修改')" href="tea_info_edit.aspx" target="content3">
                                                        <span>信息修改</span></a></li>
                                                    <li id="Li2"><a title="密码修改" onclick="show_title('密码修改')" href="tea_psd_edit.aspx" target="content3">
                                                        <span>密码修改</span></a></li>
                                                </ul>
                                            </div>
                                            <div class="clear">
                                            ...
                                            <ul class="tabpage2">
                                                <li id="left_tab2" onClick="javascript:border_left('left_tab2','left_menu_cnt2');" title="操作菜单"><span> 评分</span></li>
                                            </ul>
                                            <div id="left_menu_cnt2" class="left_menu_cnt">
                                                <ul id="dleft_tab2">
                                                    <li id="Li3"><a title="课程打分" onclick="show_title('课程打分')" href="tea_score_edit.aspx" target="content3">
                                                        <span>课程打分</span></a></li>
                                            ...
                                            <ul class="tabpage2">
                                                <li id="left_tab3" onClick="javascript:border_left('left_tab3','left_menu_cnt3');" title="操作菜单"><span>名单</span></li>
                                            </ul>
                                            <div id="left_menu_cnt3" class="left_menu_cnt">
                                                <ul id="dleft_tab3">
                                                    <li id="Li5"><a title="课程名单" onclick="show_title('课程名单')" href="tea_course_name.aspx" target="content3">
                                                        <span>课程名单</span></a></li>
