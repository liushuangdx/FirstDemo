<%@ Page Language="C#" AutoEventWireup="true" CodeFile="stu_score_sel.aspx.cs" Inherits="stu_score_sel" %>
...
<body>
    ...
    <asp:Panel ID="selectscore_panel" runat="server" Visible="true">
                  ...
                  <div class="content-box-content">
                    <div class="tab-content default-tab" id="Div9">
		                <div style="width:100%;">
                            ...
                            <asp:ListView ID="ScoreListView" runat="server" 
